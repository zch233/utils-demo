...
/**
 * 文档地址：https://release.group-ds.com/dev-newbee-handbook/utils/utils.html#signatureboard
 */
export class SignatureBoard {
    ...
    init(canvas: HTMLCanvasElement, options: IOptions = {}) {
        ...
        this.bgImage = options.bgImage || this.bgImage;
        ...
        this.drawBgColor();
        if (this.bgImage) {
            this.drawByImageUrl(this.bgImage, 'contain');
        }
        this.addListener();
    }
    ...
    drawByImageUrl = (url: string, type?: string) => {
        ...
        image.onload = () => {
            ...
            if (type === 'contain') {
                if (this.width > this.height) {
                    ...
                    drawWidth = (this.height * image.width) / image.height;
                } else {
                    drawWidth = this.width;
                    drawHeight = (this.width * image.height) / image.width;
                }
            }
